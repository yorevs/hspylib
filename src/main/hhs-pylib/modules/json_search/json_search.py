...
class JsonSearch:
    ...
    def __findNextElement__(self, root_element, match_name, match_value=None, fetch_parent=False):
        ...
        if type(selected_element) is list:
            ...
            for nextInList in root_element:
                ...
                if type(nextInList) is dict:
                    ...
                    selected_element = self.__findNextElement__(nextInList, match_name, match_value)
    ...
    def __findInSubex__(self, sub_expressions, sub_selected_element, pat_subst_expr_val, fetch_parent=False):
        ...
        for nextSubExpr in sub_expressions:
            ...
            if nextSubExpr:
                ...
                sub_selected_element = self.__findNextElement__(
    ...
    def jsonSelect(self, root_element, search_path, fetch_parent=False):
        ...
        try:
            ...
            for nextElement in search_tokens:
                ...
                if nextElement.find('{') >= 0:  # Next element has nested elements
                    ...
                    if selected_element:
                        ...
                        if type(selected_element) is list:
                            ...
                            for nextInList in selected_element:
                                ...
                                sub_selected_element = self.__findInSubex__(
                    ...
                    if not sub_elem_id is None and not elem_array_index is None:
